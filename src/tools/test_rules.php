...
// ---------------------------------------------------------------------------
section('Spell slots, levels 1-6');
...
same('a fighter has no slots', [1 => 0, 2 => 0, 3 => 0], Rules::slotTable('Fighter', 6));
same('slot levels clamp low', Rules::slotTable('Wizard', 1), Rules::slotTable('Wizard', 0));
same('slot levels clamp high', Rules::slotTable('Wizard', 6), Rules::slotTable('Wizard', 12));
