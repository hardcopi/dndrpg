...
final class AdventureBook
{
    ...
    private function monsters(array $encounters, array $alsoKeys = []): array
    {
        ...
        // Format only. Which creatures belong in THIS book is decided above;
        // Bestiary is the catalogue, and asking it for `all()` here is how
        // Rivermark would print the Old City's bosses.
        return (new Bestiary($this->db))->ofKeys(array_keys($keys));
    }
